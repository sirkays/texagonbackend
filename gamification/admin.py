...
class AchievementAcquiredAdmin(admin.ModelAdmin):
    autocomplete_fields = ['definition', 'student', 'season']
...
class BadgeAwardAdmin(admin.ModelAdmin):
    autocomplete_fields = ['badge', 'student', 'season']
...
class PointTransactionAdmin(admin.ModelAdmin):
    autocomplete_fields = ['student', 'season']
...
class ActivityEventAdmin(admin.ModelAdmin):
    autocomplete_fields = ['organization', 'student', 'season']
